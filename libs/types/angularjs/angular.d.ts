...
declare module ng {
    ...
    export interface IFilterProvider extends IServiceProvider {
    ...
    ///////////////////////////////////////////////////////////////////////////
    export interface IDocumentService extends Document {}
    ...
    export interface IAnchorScrollProvider extends IServiceProvider {
    ...
    export interface ICompileProvider extends IServiceProvider {
    ...
    export interface IControlerProvider extends IServiceProvider {
    ...
    export interface IHttpPromise extends IPromise {
    ...
    export interface IHttpProvider extends IServiceProvider {
        defaults: IRequestConfig;
    ...
    export interface IInterpolateProvider extends IServiceProvider {
        startSymbol(): string;
    ...
    ///////////////////////////////////////////////////////////////////////////
    export interface IRootScopeService extends IScope {}
    ...
    export interface ICurrentRoute extends IRoute {
        locals: {
            $scope: IScope;
            $template: string;
        };
    ...
    export interface IRouteProvider extends IServiceProvider {
